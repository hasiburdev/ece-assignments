...
3. [An array A Containing N elements is given. Write a program that captures the sum of array elements.](./assignment/03.mdx)
4. [Write a program to find whether the array of integers contains a duplicate number.](./assignment/04.mdx)
5. [Write a program to insert a number at a given location in an array.](./assignment/05.mdx)
6. [Write a program to delete a number from a given location in an array.](./assignment/06.mdx)
7. [Write a program to merge two sorted arrays.](./assignment/07.mdx) **Does the answer need to be sorted as well?**
